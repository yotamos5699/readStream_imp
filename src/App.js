...
const reqData = {
  ...
  matrixesData: {
    mainMatrix: {
      matrixID: "9321b6eb28c9c3b035bef8984863b2dd887d98d9ad89ea4c9112d3021da3da19",
      ActionID: [1, 1],
      AccountKey: ["6026", "6027"],
      DocumentID: [1, 1],
      DriverID: ["qewr135256edrfh", "qewr135256edrfh"],
      ActionAutho: ["Default", "Default"],
      itemsHeaders: ["HI250SA", "SX250SA", "AB500SA"],
      itemsNames: ["הרנה 250 גרם", "גת SPXP", "אבו מיסמר גדול"],
      cellsData: [
        [3, 2, 1],
        [1, 0, 0],
      ],
...
function App() {
  ...
  const fetchDocs = async () => {
    ...
    return fetch("http://localhost:3000/api/createdoc", requestOptions)
